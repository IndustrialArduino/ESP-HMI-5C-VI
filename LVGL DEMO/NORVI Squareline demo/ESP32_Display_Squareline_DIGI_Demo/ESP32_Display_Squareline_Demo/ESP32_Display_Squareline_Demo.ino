...
void loop() {
  ...
  lv_label_set_text_fmt(ui_Label6, "%d", inputValues[0]);
  lv_label_set_text_fmt(ui_Label7, "%d", inputValues[1]);
  lv_label_set_text_fmt(ui_Label8, "%d", inputValues[2]);
  lv_label_set_text_fmt(ui_Label9, "%d", inputValues[3]);
#endif
}
