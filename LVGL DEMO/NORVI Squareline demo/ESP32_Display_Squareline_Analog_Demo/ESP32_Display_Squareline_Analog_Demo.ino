...
void loop()
{
  ...
  // Assuming you have labels with names label_analog1, label_analog2, label_analog3, and label_analog4
  lv_label_set_text_fmt(ui_Label6, "%d", adc0_2);
  lv_label_set_text_fmt(ui_Label7, "%d", adc1_2);
  lv_label_set_text_fmt(ui_Label8, "%d", adc2_2);
  lv_label_set_text_fmt(ui_Label9, "%d", adc3_2);
